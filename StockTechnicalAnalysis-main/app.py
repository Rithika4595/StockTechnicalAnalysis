...
def predict():
    ...
    return render_template(
        ...
        bullishness_rating=bullishness_rating,
        bearishness_rating=bearishness_rating,
        sma_50=sma_50,
        sma_200=sma_200,
        rsi=rsi,
        macd=macd,
...
def make_prediction(symbol):
    ...
    # FIX:
    # Convert dataframe columns into 1D Series
    ...
    bullishness_rating = (
        sum(bullish_indicators) * 10 / len(bullish_indicators)
    )


    bearishness_rating = (
        sum(bearish_indicators) * 10 / len(bearish_indicators)
    )
...
def get_suggestion(prediction):
    ...
    if prediction == "Bullish":
        ...
        suggestion = (
            "Considering the positive indicators, "
            "it may be a good time to buy or hold the stock."
        )
        ...
        suggestion = (
            ...
            "Consider holding if you already own it."
        )
        ...
        suggestion = (
            "Indicators are weak. "
            "Consider avoiding or selling the stock."
        )
